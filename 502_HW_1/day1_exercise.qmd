...
WRITE YOUR ANSWER HERE #(4 *30 +6) ^ 0.5 = 11.22497
...
WRITE YOUR ANSWER (code) HERE  part.1 = 30 +6

### 4-2: Create an object called part.2 that is equal to 4 times part.1

WRITE YOUR ANSWER (code) HERE  part.2 = 4 *part.1

### 4-3: Raise part.2 to the power of 0.5

WRITE YOUR ANSWER (code) HERE  part.2 ^0.5
...
WRITE YOUR ANSWER (code) HERE typeof(c("aa", "bb"))

### 5-2 Create a numeric vector and coerce it to a factor vector. It'd be nice if you can do it in one line of code

WRITE YOUR ANSWER (code) HERE  object = c(1)
> object = as.factor(object)  Maybe also: object1 = as.factor(c(1,2,3))
